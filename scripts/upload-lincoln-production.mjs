/**
 * Uploads the Lincoln Legacy building listing to production dataset with local images.
 * Usage: SANITY_TOKEN=<token> node scripts/upload-lincoln-production.mjs
 */
