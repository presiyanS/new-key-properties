/**
 * Uploads Apartment Б41 (Малинова Долина) to production.
 * Usage: SANITY_TOKEN=<token> node scripts/upload-b41-production.mjs
 */
...
const imagePaths = [
  '/Users/presiyansokolov/Downloads/Ап. Б41.png',
...
const description = `Апартаментът е двустаен, разположен на четвърти етаж. Застроената площ на апартамента е 69,48 кв.м., а общата площ е 78,37 кв.м. Състои се от преддверие, функционална дневна с обособена кухненска част, спалня, баня с тоалетна, сервизно/перално помещение и тераса. Изложението е запад.
...
const listing = {
  _type: 'listing',
  title: 'Двустаен апартамент Б41 — Малинова Долина',
  type: 'sale',
  price: '188088',
  area: '78.37',
  rooms: '2',
