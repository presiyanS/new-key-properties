/**
 * Uploads the Amalia building listing to staging dataset with local images.
 * Usage: SANITY_TOKEN=<token> node scripts/upload-amalia-staging.mjs
 */
...
console.log('\nDone! Check staging to review the listing.')
