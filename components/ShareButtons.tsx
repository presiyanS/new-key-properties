  ...
  return (
    <div className="flex items-center gap-2 pt-6 border-t border-gray-100 mt-8">
      ...
      <a
        ...
        aria-label={dict.listings.shareFacebook}
      >
      ...
      <a
        ...
        aria-label={dict.listings.shareWhatsapp}
      >
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
      ...
      <a
        ...
        aria-label={dict.listings.shareViber}
      >
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
      ...
      <button
        ...
        aria-label={dict.listings.copyLinkAria}
      >
        {copied ? (
          <>
