      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="hidden lg:flex items-center gap-3 shrink-0">
            ...
            <a
              href={`tel:${phone}`}
              className="flex items-center gap-2 bg-brand-gold text-brand-green font-bold px-5 py-2.5 rounded-xl hover:bg-brand-gold-light transition-all hover:shadow-lg hover:shadow-brand-gold/20 active:scale-95 text-sm shrink-0 whitespace-nowrap"
            >
