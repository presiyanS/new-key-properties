      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center gap-3 mr-2">
            <a href="https://www.facebook.com/profile.php?id=61582999994088" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-brand-gold/60 hover:text-brand-gold transition-colors">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                <path d="M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073C0 18.1 4.388 23.094 10.125 24v-8.437H7.078v-3.49h3.047V9.41c0-3.025 1.792-4.697 4.533-4.697 1.312 0 2.686.236 2.686.236v2.97h-1.513c-1.491 0-1.956.93-1.956 1.886v2.268h3.328l-.532 3.49h-2.796V24C19.612 23.094 24 18.1 24 12.073z"/>
              </svg>
            </a>
            <a href="https://www.instagram.com/new_key_properties" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-brand-gold/60 hover:text-brand-gold transition-colors">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://www.linkedin.com/company/new-key-properties/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-brand-gold/60 hover:text-brand-gold transition-colors">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
      ...
      {open && (
        <div className="lg:hidden bg-brand-green-dark border-t border-brand-gold/20">
          <div className="px-4 py-4 space-y-1">
            ...
            <div className="flex items-center gap-4 mt-4 pt-4 border-t border-brand-gold/10">
              <a href="https://www.facebook.com/profile.php?id=61582999994088" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-brand-gold/60 hover:text-brand-gold transition-colors">
