...
const defaultFaqs = [
  ...
  {
    q: 'Обвързвам ли се с дългосрочен или ексклузивен договор?',
    a: 'Не. Работим на доверие, а не на обвързване — не изискваме дългосрочни ексклузивни договори, за да продължите работата с нас. Вярваме, че клиентите остават, защото са доволни от резултата, а не защото договор ги задължава. Условията обсъждаме открито в самото начало, преди да поемем ангажимент.',
  },
  {
    q: 'Ами ако не намерите точния имот, който търся?',
    a: 'Работим с ограничен брой клиенти всеки месец точно за да можем да отделим нужното време и внимание, докато намерим правилния имот за Вас — дори ако това отнеме повече от очакваното. Не предлагаме имоти само за да приключим сделка; показваме Ви само това, което наистина отговаря на критериите Ви. Щом се появи подходящ имот, Вие сте първите, които научават.',
  },
  {
