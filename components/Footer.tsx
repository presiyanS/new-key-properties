...
export default function Footer({
  ...
  const socials = [
    {
      href: settings?.facebookUrl ?? 'https://www.facebook.com/profile.php?id=61582999994088',
      label: 'Facebook',
    ...
    {
      href: settings?.instagramUrl ?? 'https://www.instagram.com/new_key_properties',
      label: 'Instagram',
    ...
    {
      href: settings?.linkedinUrl ?? 'https://www.linkedin.com/company/new-key-properties/',
      label: 'LinkedIn',
  ...
  return (
    <footer className="bg-brand-green-dark text-brand-gold/70 relative overflow-hidden">
      <div className="h-px bg-linear-to-r from-transparent via-brand-gold/40 to-transparent" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            />
            <p className="text-sm leading-relaxed mb-4 text-brand-gold/60 whitespace-pre-line">
              {tagline}
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li>
                <a href={`tel:${phone}`} className="flex items-center gap-3 hover:text-brand-gold transition-colors group">
              ...
              <li>
                <a href={`mailto:${email}`} className="flex items-center gap-3 hover:text-brand-gold transition-colors group">
                  <div className="w-8 h-8 rounded-lg bg-brand-gold/10 group-hover:bg-brand-gold/20 flex items-center justify-center shrink-0 transition-colors">
                    <svg className="w-4 h-4 text-brand-gold" fill="currentColor" viewBox="0 0 24 24">
