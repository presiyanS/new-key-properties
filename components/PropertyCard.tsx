    ...
    >
      ...
      <div className="relative h-60 overflow-hidden bg-brand-green/10">
        ...
        {listing.status === 'active' && listing.featured && (
          <div className="absolute top-0 right-0 w-28 h-28 overflow-hidden pointer-events-none z-20">
            <div className="absolute top-5 -right-7 w-36 bg-brand-gold text-brand-green text-[10px] font-black uppercase tracking-widest text-center py-1.5 rotate-45 shadow-lg">
              {dict.listings.featuredBadge}
            </div>
          </div>
        )}
