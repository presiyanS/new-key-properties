              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 mb-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8 p-5 bg-gray-50 rounded-xl">
                  {[
                    ...
                    { label: 'Етаж', val: listing.floor ? `${listing.floor}/${listing.totalFloors}` : '–' },
            ...
            <div>
              <div className="bg-white rounded-2xl p-7 shadow-sm border border-gray-100 sticky top-28">
                ...
                <div className="space-y-3 mb-8">
                  <a
                    href="tel:0879826292"
                    className="flex items-center justify-center gap-3 bg-brand-green text-brand-gold font-bold py-4 rounded-xl hover:bg-brand-green-light transition-colors w-full"
                  >
                  ...
                  <a
                    ...
                    className="flex items-center justify-center gap-3 border-2 border-brand-green text-brand-green font-bold py-3.5 rounded-xl hover:bg-brand-green/5 transition-colors w-full text-sm"
                  >
                    office@newkey.bg
                  </a>
                </div>
