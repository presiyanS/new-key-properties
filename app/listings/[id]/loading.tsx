    ...
    <div className="animate-pulse">
      ...
      <div className="bg-brand-green py-5 border-b border-brand-gold/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="h-4 w-40 bg-brand-gold/20 rounded-sm" />
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-xs border border-gray-100 space-y-4">
                <div className="h-8 w-3/4 bg-gray-200 rounded-sm" />
                <div className="h-6 w-1/3 bg-gray-200 rounded-sm" />
                <div className="grid grid-cols-5 gap-4 p-5 bg-gray-50 rounded-2xl">
                  {[...Array(5)].map((_, i) => (
                    <div key={i} className="space-y-2 text-center">
                      <div className="h-5 w-5 bg-gray-200 rounded-sm mx-auto" />
                      <div className="h-3 w-12 bg-gray-200 rounded-sm mx-auto" />
                      <div className="h-4 w-10 bg-gray-200 rounded-sm mx-auto" />
                    </div>
                  ))}
                </div>
            ...
            <div>
              <div className="bg-white rounded-2xl p-7 shadow-xl border border-gray-100 space-y-4">
                ...
                <div className="h-6 w-3/4 bg-gray-200 rounded-sm" />
                <div className="h-4 w-full bg-gray-200 rounded-sm" />
