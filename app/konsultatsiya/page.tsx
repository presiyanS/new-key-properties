    ...
    cms?.faq?.length > 0
      ...
      : [
          ...
          },
          {
            ...
            a: 'Работим в цяла София, но специализираме в: Драгалевци, Младост, Овча купел, Дружба, Monastery Livadi и центъра.',
          },
        ]
          ...
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-brand-gold/10 border border-brand-gold/30 rounded-full px-4 py-2 mb-6 animate-fade-in">
              ...
              <span className="text-brand-gold text-sm font-medium">
                {cms?.heroBadge ??
                  `Ограничени места за месец ${new Date().toLocaleDateString('bg-BG', { month: 'long', year: 'numeric' })}`}
              </span>
            </div>
            ...
            <p
              className="text-white/70 text-xl leading-relaxed mb-10 max-w-2xl animate-fade-up"
            ...
            {benefits.map((b: { title: string; desc: string }, i: number) => (
              <AnimatedSection key={i} delay={i * 0.1}>
                <div className="bg-gray-50 rounded-2xl p-7 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-gray-100 group h-full">
                  ...
                  <h3 className="font-bold text-brand-green text-lg mb-2 group-hover:text-brand-green-light transition-colors">
                    {b.title}
                  </h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            {stats.map((s: { value: string; label: string }, i: number) => (
              <AnimatedSection key={i} delay={i * 0.1}>
                <div className="group">
                  <p className="font-serif text-5xl font-bold text-brand-gold mb-2 group-hover:scale-105 transition-transform inline-block">
                    {s.value}
                  </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <AnimatedSection direction="right" delay={0.15}>
              <div className="bg-white rounded-3xl p-8 lg:p-10 shadow-xl border border-gray-100">
                <span className="text-brand-gold/60 uppercase text-xs tracking-widest font-medium">Безплатно</span>
                <h3 className="font-serif text-2xl font-bold text-brand-green mt-2 mb-2">Вашето запитване</h3>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="text-center mb-12">
            ...
            <h2 className="font-serif text-4xl font-bold text-brand-green mt-3">Често задавани въпроси</h2>
          </AnimatedSection>
      ...
      <section className="py-20 bg-brand-green relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          <AnimatedSection>
            ...
            <p className="text-white/70 text-lg mb-10">Първата стъпка е безплатна. Свържете се с нас днес.</p>
