...
7. Валута — САМО евро (€ / евро), никога лева/BGN/лв. България е в еврозоната от 1 януари 2026 г. Единственото допустимо изключение: статия, чиято изрична тема е самият преход лев→евро или историята на курса — там левът може да се спомене като исторически факт, но дори и тогава никога не изразявай цена на имот или пример в лева
8. Дължина на "content": 600–900 думи
9. Структура на "content": увод (без собствено заглавие) → основно съдържание (2-4 секции, всяка от които започва на собствен ред със заглавие на секцията, обвито в двойни звездички, напр. **Заглавие на секцията** — само заглавието на реда, нищо друго) → заключение, също започващо със заглавие на собствен ред (напр. **Заключение**), с покана за безплатна консултация на 0879 826 292
10. Единственото разрешено markdown форматиране в "content" е двойните звездички около заглавията на секциите, описани в правило 9. Никъде другаде не използвай markdown (без #, _, списъци с тирета/номера и т.н.) — обикновен текст с нови редове между абзаците. Самият "content" не съдържа заглавие на цялата статия в себе си (то е в "title")
11. "title": кратко, привлекателно заглавие (максимум 70 знака), sentence case — главна буква само на първата дума и на собствени имена (напр. София, България), НЕ Title Case
12. "excerpt": кратко резюме, максимум 200 знака
13. "titleEn", "excerptEn", "contentEn": точен, естествен превод на английски на съответните полета — същите факти, цифри и глаголни времена спрямо днешната дата, без добавяне или пропускане на съдържание, включително същите **заглавия на секции** на същите места. "titleEn" също е в sentence case (главна буква само на първата дума и на собствени имена), не Title Case
14. Върни САМО валиден JSON във формат {"title":"...","titleEn":"...","excerpt":"...","excerptEn":"...","content":"...","contentEn":"..."}, без markdown форматиране, без обяснения преди или след него`
}
