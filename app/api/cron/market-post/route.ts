...
function buildResearchSystemPrompt(todayISO: string) {
...
5. Върни САМО валиден JSON, без markdown форматиране, без обяснения преди или след него, в следния формат:
...
function buildWritingSystemPrompt(todayISO: string) {
...
4. Използвай САМО фактите, дадени ти по-долу в JSON. Никога не измисляй и не закръгляш цени, лихвени проценти или суми, които не са дадени там
5. Ако ти трябва конкретна цена за въображаем пример, изведи я чрез изчисление от дадените данни и покажи изчислението
6. Дължина на "content": 600–900 думи
7. Структура на "content": увод → основно съдържание (2-4 секции) → заключение с покана за безплатна консултация на 0879 826 292
8. "content" не съдържа markdown форматиране (без #, **, _ и т.н.) — само обикновен текст с нови редове, и не съдържа заглавие в себе си
9. "title": кратко, привлекателно заглавие (максимум 70 знака), sentence case — главна буква само на първата дума и на собствени имена (напр. София, България), НЕ Title Case
10. "excerpt": кратко резюме, максимум 200 знака
11. "titleEn", "excerptEn", "contentEn": точен, естествен превод на английски на съответните полета — същите факти, цифри и глаголни времена спрямо днешната дата, без добавяне или пропускане на съдържание. "titleEn" също е в sentence case (главна буква само на първата дума и на собствени имена), не Title Case
12. Върни САМО валиден JSON във формат {"title":"...","titleEn":"...","excerpt":"...","excerptEn":"...","content":"...","contentEn":"..."}, без markdown форматиране, без обяснения преди или след него`
}
